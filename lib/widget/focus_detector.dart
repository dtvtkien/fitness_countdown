...
class FocusDetector extends StatefulWidget {
  ...
  const FocusDetector({
    ...
    this.onFocusGained,
    this.onFocusLost,
    double thresholdVisible,
  })  : assert(key != null),
        assert(child != null),
        this.thresholdVisible = thresholdVisible ?? 0.99,
        super(key: key);
...
class _FocusDetectorState extends State<FocusDetector>
  ...
  Widget build(BuildContext context) => VisibilityDetector(
        ...
        onVisibilityChanged: (visibilityInfo) {
          ...
          _isVisible = visibilityInfo.visibleFraction > widget.thresholdVisible;
